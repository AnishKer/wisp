      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
            ...
            <div className='relative py-2 group'> 
                <img src={assets.menu_icon} alt="Menu" className='max-h-5 cursor-pointer group-hover:block'/>
      ...
      <div className='flex flex-col'>
        {userDummyData.map((user, index) =>(
            <div onClick={() => {setSelectedUser(user)}}
             key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-point max-sm:text-sm ${selectedUser?.id === user._id && 'bg-[#282142]/50'}`}>
